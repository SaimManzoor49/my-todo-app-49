    ...
    return (
        <>
            ...
            <div className="container-fluid  d-flex align-items-center justify-content-center flex-column  " style={{ minHeight: "100vh" }} >
                <div className="row   ">
                    <div className="col-12 col-sm-6 col-md-6 w1       col-xxl-6          py-sm-4 py-md-0 py-4 rounded-3 shadow-lg bg-transparent mt-5 d-flex align-items-center justify-content-center flex-column " style={{ maxHeight: "73vh" }}>
                        <h2 className='text-center border-bottom border-3 border-dark mb-'>Login Please!</h2>
                        <form className='mt-'>
                            <div className="mb-2  border-start mb-4">
                                <input type="email" className="py-1 fs form-control border-0 border-start border-primary border-5" placeholder='   |  Input your email here!' id="exampleInputEmail1" aria-describedby="emailHelp" />
                            ...
                            <div className="text-center">
                                <button type="submit" className="btn mt- btn-primary mt- btn-hover px-4 fs-5 py-1">LOGIN</button>
                            </div>
                        </form>
                    </div>

                    <div className="col-12 col-sm-6 col-md-6 py-3 w2      col-xxl-6       d-flex rounded-3 shadoww text-white bg align-items-center justify-content-center flex-column minus " style={{ minHeight: "79vh" }}>
                        {/* <BgAnimated1 /> */}
